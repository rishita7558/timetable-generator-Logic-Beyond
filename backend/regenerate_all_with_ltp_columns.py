#!/usr/bin/env python3
"""
Regenerate ALL semester timetables with new L/T/P verification columns.
"""
import os
import sys
import glob
...
print("\n" + "="*80)
print("REGENERATING ALL TIMETABLES WITH L/T/P VERIFICATION COLUMNS")
print("="*80)
...
print("="*80)
print("\nAll timetables now include Lectures/Week, Tutorials/Week, Labs/Week columns")
print("in the CORE COURSES section of each timetable sheet.")
